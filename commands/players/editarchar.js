...
module.exports = {
    data: new SlashCommandBuilder().setName("editarchar").setDescription("Altera um atributo do seu personagem")
        .addStringOption(option => option.setName("char").setRequired(true).setAutocomplete(true).setDescription("Nome do personagem"))
        .addStringOption(option => option.setName("atributo").setDescription("Atributo a ser mudado").setRequired(true)
                            .addChoices({name:"Nome", value:"name"}, {name:"Vida", value:"basehp"}, 
                                {name:"Bônus de iniciativa", value:"initiative"}, {name:"Vantagem na iniciativa", value:"initiativeAdvantage"}))
        .addStringOption(option => option.setName("novovalor").setDescription("Novo valor do atributo").setRequired(true)),
